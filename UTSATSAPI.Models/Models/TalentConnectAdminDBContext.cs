...
namespace UTSATSAPI.Models.Models
{
    public partial class TalentConnectAdminDBContext : DbContext
    {
        ...
        public virtual DbSet<Sproc_Get_Candidate_Details_For_Job_Result> Sproc_Get_Candidate_Details_For_Job_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Add_CompanyData_Send_Details_To_ATS_Result> Sproc_Get_Add_CompanyData_Send_Details_To_ATS_Result { get; set;} = null!;
        public virtual DbSet<Sproc_Get_Nurture_Email_List_Result> Sproc_Get_Nurture_Email_List_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Summary_Emails_Result> Sproc_Get_Summary_Emails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Engagement_Renewal_Emails_Details_Result> Sproc_Get_Engagement_Renewal_Emails_Details_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Engagement_Renewal_Emails_EngagementList_Result> Sproc_Get_Engagement_Renewal_Emails_EngagementList_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Email_SubjectList_Result> Sproc_Get_Email_SubjectList_Result { get; set; } = null!;
        public virtual DbSet<Sproc_SearchLocationOnly_Result> Sproc_SearchLocationOnly_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Credit_Expiry_Email_Notification_ClientPortal_Result> Sproc_Get_Credit_Expiry_Email_Notification_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_ListOfHR_For_NewCandidate_Added_Email_ClientPortal_Result> Sproc_Get_ListOfHR_For_NewCandidate_Added_Email_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<sp_UTS_get_HRTalentDetails_UsingPagination_Result> sp_UTS_get_HRTalentDetails_UsingPagination_Result { get; set; } = null!;
        public virtual DbSet<sp_UTS_get_HRHistory_UsingPagination_Result> sp_UTS_get_HRHistory_UsingPagination_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_NearByMAppingCities_Result> Sproc_Get_NearByMAppingCities_Result { get; set; } = null!;
        public virtual DbSet<Sproc_SearchLocation_Result> Sproc_SearchLocation_Result { get; set; } = null!;
        public virtual DbSet<sproc_ViewAllUnAssignedHRs_Result> Sproc_ViewAllUnAssignedHRs_Results { get; set; } = null!;
        public virtual DbSet<Sproc_GetStandOutDetails_ClientPortal_Result> Sproc_GetStandOutDetails_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_PrgSkill_NotusedinMappingtables_Result> Sproc_Get_PrgSkill_NotusedinMappingtables_Results { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetUsers_Result> GetUsers_Result { get; set; } = null!;
        public virtual DbSet<sproc_ViewAllHRs_Result> ViewAllHRs_Results { get; set; } = null!;
        public virtual DbSet<sp_get_HRClientDetails_Result> HRClientDetails_Results { get; set; } = null!;
        public virtual DbSet<sp_get_HRHistory_Result> HRHistory_Results { get; set; } = null!;
        public virtual DbSet<sp_get_HRTalentDetails_Result> HRTalentDetails_Results { get; set; } = null!;
        public virtual DbSet<sp_getInterviewdetailsForViewAllHR_Result> InterviewdetailsForViewAllHR_Results { get; set; } = null!;
        public virtual DbSet<sproc_FetchMissingAction_Result> FetchMissingAction_Results { get; set; } = null!;
        public virtual DbSet<sproc_NextActionsForTalent_Result> NextActionsForTalent_Results { get; set; } = null!;
        public virtual DbSet<Sproc_Get_TalentDetails_For_Managed_HR_Result> TalentDetails_For_Managed_HR_Results { get; set; } = null!;
        public virtual DbSet<SP_NextActionsForManagedHR_Result> NextActionsForManagedHR_Results { get; set; } = null!;
        public virtual DbSet<sproc_Insert_HiringRequest_PriorityHistory> InsertHiringRequestPriorityHistory { get; set; } = null!;
        public virtual DbSet<Sproc_GetPointOfContact_UserDetails_Result> Sproc_GetPointOfContact_UserDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetCompanyDetail_Result> Sproc_GetCompanyDetail_Result { get; set; } = null!;
        public virtual DbSet<sproc_ViewTalent_Result> sproc_ViewTalent_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_getCompanyNameByHiringRequestID> sproc_UTS_getCompanyNameByHiringRequestID { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetTalentProfileLog_Result> sproc_UTS_GetTalentProfileLog_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetProfileShareDetail_Result> sproc_UTS_GetProfileShareDetail_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetTalentScoreCard_Result> sproc_UTS_GetTalentScoreCard_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetHiringInterview_Result> sproc_GetHiringInterview_Result { get; set; } = null!;
        public virtual DbSet<Sproc_InsertBookSlot_Result> Sproc_InsertBookSlot_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetDealList_Result> sproc_UTS_GetDealList_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetDealCompanyDetails_Result> sproc_UTS_GetDealCompanyDetails_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetDealLeadDetails_Result> sproc_UTS_GetDealLeadDetails_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetDealPrimary_SecondaryClient_Result> sproc_UTS_GetDealPrimaryClient_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetDealActivity_Result> sproc_UTS_GetDealActivity_Result { get; set; } = null!;
        public virtual DbSet<sproc_Get_ContactPointofContact_Result> sproc_Get_ContactPointofContact_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetExtractedSkills_FromJD_Result> Sproc_GetExtractedSkills_FromJD_Result { get; set; } = null!;
        public virtual DbSet<Sproc_DumpJDDetailsintoTempTable_Result> Sproc_DumpJDDetailsintoTempTable_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_GetCompanyList_Result> Sproc_UTS_GetCompanyList_Results { get; set; } = null!;
        public virtual DbSet<sproc_GetOnBoardData_Result> sproc_GetOnBoardData_Result { get; set; } = null!;
        public virtual DbSet<Sproc_InterviewRoundDetails_Result> Sproc_InterviewRoundDetails_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetTalentList_Result> sproc_UTS_GetTalentList_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_ManagedTalent_Result> Sproc_UTS_ManagedTalent_Results { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_GetTalentLegalInfo_Result> Sproc_UTS_GetTalentLegalInfo_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetAMAssignments_Result> sproc_UTS_GetAMAssignments_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetAMAssignmentRules_Result> sproc_UTS_GetAMAssignmentRules_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetCompanyLegalInfo_Result> sproc_GetCompanyLegalInfo_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_GetHubSpotCompanyList_Result> Sproc_UTS_GetHubSpotCompanyList_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetClientList_Result> sproc_UTS_GetClientList_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetClientHappinessSurvey_Result> sproc_GetClientHappinessSurvey_Result { get; set; } = null!;
        public virtual DbSet<sproc_Inc_GetUsers_RoleDetails_Result> sproc_Inc_GetUsers_RoleDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_Get_Inc_PlacementFees_Slab_Result> Sproc_UTS_Get_Inc_PlacementFees_Slab_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_Get_Acheived_Target_Details_Result> Sproc_UTS_Get_Acheived_Target_Details_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_Get_Inc_AM_NRSlab_Result> Sproc_UTS_Get_Inc_AM_NRSlab_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetAutoCompleteContacts_Result> sproc_UTS_GetAutoCompleteContacts_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetBDR_Marketingusers> sproc_UTS_GetBDR_Marketingusers { get; set; } = null!;
        public virtual DbSet<SPROC_UTS_UserGeoValues_Result> SPROC_UTS_UserGeoValues_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_HR_PrioritySet> sproc_UTS_HR_PrioritySet { get; set; } = null!;

        public virtual DbSet<Sproc_GET_PostAcceptance_detail_Result> Sproc_GET_PostAcceptance_detail_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GET_PostAcceptance_detail_Availability_Result> Sproc_GET_PostAcceptance_detail_Availability_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GET_PostAcceptance_detail_HowSoon_Result> Sproc_GET_PostAcceptance_detail_HowSoon_Result { get; set; } = null!;
        public virtual DbSet<sp_get_UTS_GetFilterTypeForDeals_Result> sp_get_UTS_GetFilterTypeForDeals_Result { get; set; } = null!;
        public virtual DbSet<Sproc_prg_TempSkills_Insert> Sproc_prg_TempSkills_Insert { get; set; } = null!;
        public virtual DbSet<sproc_UTS_FetchInterviewerDetails_Result> sproc_UTS_FetchInterviewerDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Add_Confirm_Interview_Slot_Result> Sproc_Add_Confirm_Interview_Slot_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_BusinessDashboard_Result> Sproc_Get_BusinessDashboard_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_AMNBD_For_Replacement_Result> Sproc_Get_AMNBD_For_Replacement_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Add_TalentReplacement_details_Result> Sproc_Add_TalentReplacement_details_Result { get; set; } = null!;
        public virtual DbSet<SaveTalentReplacement> SaveTalentReplacement { get; set; } = null!;
        public virtual DbSet<NRPerCentageValue> NRPerCentageValue { get; set; } = null!;
        public virtual DbSet<SP_UTS_ESales_Get_Client_AM_Details_Result> SP_UTS_ESales_Get_Client_AM_Details_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_Get_TalentDetails_For_ContractualtoDP_Conversion_Result> Sproc_UTS_Get_TalentDetails_For_ContractualtoDP_Conversion_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_Get_TalentDetails_For_DPToContractual_Conversion_Result> Sproc_UTS_Get_TalentDetails_For_DPToContractual_Conversion_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetReportingUsers_Result> sproc_GetReportingUsers_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GET_ALL_HR_Details_For_PHP_API_Result> Sproc_GET_ALL_HR_Details_For_PHP_API_Result { get; set; } = null;
        public virtual DbSet<sproc_GetSkillsAndProficiencyBasedonHR_ForPHPAPI_Result> sproc_GetSkillsAndProficiencyBasedonHR_ForPHPAPI_Result { get; set; } = null;
        public virtual DbSet<Sproc_Get_OnBoardContract_Details_Result> Sproc_Get_OnBoardContract_Details_Result { get; set; } = null;
        public virtual DbSet<Sproc_UTS_Get_OnBoardClientTeamMemberDeatils_Result> Sproc_UTS_Get_OnBoardClientTeamMemberDeatils_Result { get; set; } = null;

        public virtual DbSet<Sproc_Get_OnBoardSummary_Result> Sproc_Get_OnBoardSummary_Result { get; set; } = null;
        public virtual DbSet<Sproc_OnBoardPolicy_DeviceMaster_Update_Result> Sproc_OnBoardPolicy_DeviceMaster_Update_Result { get; set; } = null;
        public virtual DbSet<Sproc_Get_Hierarchy_For_Email_Result> Sproc_Get_Hierarchy_For_Email_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_DashBoard_OnBoardCount_Result> Sproc_UTS_DashBoard_OnBoardCount_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_InsertContactTalentPriority> sproc_UTS_InsertContactTalentPriority { get; set; } = null!;
        public virtual DbSet<Sproc_Get_OnBoardClientFeedBack_Result> Sproc_Get_OnBoardClientFeedBack_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Engagemetns_For_Replacement_BasedOn_LWD_Option_Result> Sproc_Get_Engagemetns_For_Replacement_BasedOn_LWD_Option_Result { get; set; } = null!;
        public virtual DbSet<sproc_CloneHRFromExistHR_Result> sproc_CloneHRFromExistHR_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetChildCompanyList_Result> sproc_UTS_GetChildCompanyList_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Renewal_Details_Result> Sproc_Get_Renewal_Details_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetChannelWiseFunnelReportData_For_PopUP_Result> sproc_GetChannelWiseFunnelReportData_For_PopUP_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Inc_Incentive_Report_Result> Sproc_Inc_Incentive_Report_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Managers_Result> Sproc_Get_Managers_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetInc_ReportDetails_Result> Sproc_GetInc_ReportDetails_Result { get; set; } = null!;
        public virtual DbSet<ValidationMessageForIncentiveReport> Messages { get; set; } = null!;
        public virtual DbSet<Sproc_Inc_Incentive_Report_AM_NR_Result> Sproc_Inc_Incentive_Report_AM_NR_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetInc_ReportDetails_AM_NR_Result> Sproc_GetInc_ReportDetails_AM_NR_Result { get; set; } = null!;
        public virtual DbSet<sproc_Get_TSC_List_Result> sproc_Get_TSC_List_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetInc_ReportDetails_Contract_Booster_Result> Sproc_GetInc_ReportDetails_Contract_Booster { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Users_BasedOnUserRole_Result> Sproc_Get_Users_BasedOnUserRole { get; set; } = null!;
        public virtual DbSet<SROC_GET_HIERARCHY_Result> Sroc_Get_Hierarchy { get; set; } = null!;
        public virtual DbSet<sproc_GetSupplyWiseChannelWiseFunnelReportData_For_PopUP_Result> sproc_GetSupplyWiseChannelWiseFunnelReportData_For_PopUP_Result { get; set; } = null!;
        public virtual DbSet<sproc_SkillReport_ActionWise_Result> sproc_SkillReport_ActionWise_Result { get; set; } = null!;
        public virtual DbSet<sproc_SkillReport_HRWise_Result> sproc_SkillReport_HRWise_Result { get; set; } = null!;
        public virtual DbSet<sproc_SkillReport_ActionWise_PopUp_Result> sproc_SkillReport_ActionWise_PopUp_Result { get; set; } = null!;
        public virtual DbSet<sproc_SkillReport_HRWise_PopUp_Result> sproc_SkillReport_HRWise_PopUp_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetChannelWiseFunnelReportData_For_SalesUser_PopUP_Result> sproc_GetChannelWiseFunnelReportData_For_SalesUser_PopUP_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetChannelWiseFunnelReportData_For_SalesUser_PopUP_Revised_Result> sproc_GetChannelWiseFunnelReportData_For_SalesUser_PopUP_Revised_Result { get; set; } = null!;
        public virtual DbSet<sproc_ClientBasedReport_Result> sproc_ClientBasedReport_Result { get; set; } = null!;
        public virtual DbSet<sproc_ClientBasedReport_PopUp_Result> sproc_ClientBasedReport_PopUp_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_ALL_User_HIERARCHY_SaleTarget_For_Parent_Result> Sproc_Get_ALL_User_HIERARCHY_SaleTarget_For_Parent_Result { get; set; } = null!;
        public virtual DbSet<sproc_Get_IncentiveTarget_List_New_flow> sproc_Get_IncentiveTarget_List_New_flow { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Inc_Contracts_Result> Sproc_Get_Inc_Contracts_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Inc_TalentDeploySlab_Result> Sproc_Get_Inc_TalentDeploySlab_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Inc_SALGoal_Result> Sproc_Get_Inc_SALGoal_Result { get; set; } = null!;

        public virtual DbSet<sproc_UpdateCurrencyExchangeRate_Result> sproc_UpdateCurrencyExchangeRate { get; set; } = null!;
        public virtual DbSet<Sproc_CurrencyExchangeRate_Result> Sproc_CurrencyExchangeRate { get; set; } = null!;
        public virtual DbSet<Sproc_Get_CountryList_Result> Sproc_Get_CountryList { get; set; } = null!;
        public virtual DbSet<Sproc_Get_HRDetails_For_UserPriority_Email_Result> Sproc_Get_HRDetails_For_UserPriority_Email_Result { get; set; } = null!;
        public virtual DbSet<CheckValidationMessage> CheckValidationMessageForHeadPriorityCount { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Priority_Set_Remaining_Count_Details_Result> Sproc_Get_Priority_Set_Remaining_Count_Details_Result { get; set; } = null!;
        public virtual DbSet<Sproc_SLA_OverAll_Summary_Report_Static_Stages_Result> Sproc_SLA_OverAll_Summary_Report_Static_Stages_Result { get; set; } = null!;
        public virtual DbSet<Sproc_SLA_Report_For_Static_Stages_Result> Sproc_SLA_Report_For_Static_Stages_Result { get; set; }
        public virtual DbSet<Sproc_Get_AM_User_Result> Sproc_Get_AM_User_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetTeams_Result> Sproc_GetTeams { get; set; } = null!;
        public virtual DbSet<sproc_JDParsingDumpReport_Result> sproc_JDParsingDumpReport { get; set; } = null!;
        public virtual DbSet<sproc_TalentHR_CancelledHR_List_Result> sproc_TalentHR_CancelledHR_List { get; set; } = null!;
        public virtual DbSet<Sproc_Check_Validation_Message_For_User_Edit_TR_Result> Sproc_Check_Validation_Message_For_User_Edit_TR { get; set; } = null!;
        public virtual DbSet<Sproc_UpdateTR_Result> Sproc_UpdateTR { get; set; } = null!;
        public virtual DbSet<Sproc_SLA_Missed_Summary_Report_Result> Sproc_SLA_Missed_Summary_Report_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetUserHierarchy_Result> sproc_GetUserHierarchy_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_InterviewerDetails_Result> sproc_UTS_GetCurrentInterviewerDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_InsertBookSlot_CHECK_Result> Sproc_InsertBookSlot_CHECK_Result { get; set; } = null!;
        public virtual DbSet<sproc_Insert_NextInterviewRoundDetails_WithFeedbackOption_Result> sproc_Insert_NextInterviewRoundDetails_WithFeedbackOption_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_InterviewToSuccess_PopUp_Result> sproc_Get_InterviewToSuccess_PopUp_Results { get; set; } = null!;
        public virtual DbSet<Sproc_GetInterviewToSuccessReport_Result> sproc_GetInterviewToSuccessReport_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Check_Validation_Message_For_Close_HR_Result> sproc_Check_Validation_Message_For_Close_HR_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Update_Status_For_Closed_HR_Result> sproc_Update_Status_For_Closed_HR_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetClientLogReport_Result> Sproc_GetClientLogReport_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetClientActivityLog_Result> Sproc_GetClientActivityLog_Result { get; set; } = null!;
        public virtual DbSet<Sproc_HubSpot_Client_Funnel_Report_PopUP_Result> Sproc_HubSpot_Client_Funnel_Report_PopUP_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_AddEdit_HR_Result> Sproc_UTS_AddEdit_HR_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Update_Status_For_Reopen_HR_Result> sproc_Update_Status_For_Reopen_HR_Result { get; set; } = null!;
        public virtual DbSet<sproc_HiringRequest_Report_Result> sproc_HiringRequest_Report_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_HRDetails_From_DealId_Result> Sproc_Get_HRDetails_From_DealId_Result { get; set; } = null!;
        public virtual DbSet<sproc_HiringRequest_PopupReport_Result> sproc_HiringRequest_PopupReport_Result { get; set; } = null!;
        public virtual DbSet<sproc_ClientBasedReport_WithHubSpot_Result> sproc_ClientBasedReport_WithHubSpot_Result { get; set; } = null!;
        public virtual DbSet<sproc_ClientBasedReport_WithHubSpot_PopUp_Result> sproc_ClientBasedReport_WithHubSpot_PopUp_Result { get; set; } = null!;
        public virtual DbSet<sproc_Get_PreOnboarding_Details_For_AMAssignment_Result> sproc_Get_PreOnboarding_Details_For_AMAssignment_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetAllOpenInprocessHR_BasedOnContact_Result> sproc_UTS_GetAllOpenInprocessHR_BasedOnContact_Result { get; set; } = null!;
        public virtual DbSet<sproc_Get_Onboarding_Details_For_Second_Tab_AMAssignment_Result> sproc_Get_Onboarding_Details_For_Second_Tab_AMAssignment_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetUserBy_LeadType_Result> sproc_GetUserBy_LeadType_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetAutoCompleteCompanies_Result> sproc_UTS_GetAutoCompleteCompanies_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetClientHappinessSurveyOptions_Result> sproc_GetClientHappinessSurveyOptions_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetClientHappynessSurveyFeedbackDetailForEmail_Result> sproc_GetClientHappynessSurveyFeedbackDetailForEmail_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetAutoCompleteHubSpotCompanies_Result> sproc_UTS_GetAutoCompleteHubSpotCompanies_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetCompanyDetails_Result> sproc_UTS_GetCompanyDetails_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetContactDetails_Result> sproc_UTS_GetContactDetails_Result { get; set; } = null!;
        public virtual DbSet<sp_UTS_get_HRTalentProfileReason_Result> sp_UTS_get_HRTalentProfileReason_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetTalentRoles_Result> sproc_GetTalentRoles_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetTSCUserEditDetail_Result> Sproc_GetTSCUserEditDetail_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_JDskillDataByJDDumpID_Result> Sproc_Get_JDskillDataByJDDumpID_Result { get; set; } = null!;
        public virtual DbSet<sp_UTS_GetCompanyClientDetails_Result> sp_UTS_GetCompanyClientDetails_Result { get; set; } = null!;
        public virtual DbSet<sp_UTS_GetClientWiseHRDetails_Result> sp_UTS_GetClientWiseHRDetails_Result { get; set; } = null!;
        public virtual DbSet<sp_UTS_GetPOCDetails_Result> sp_UTS_GetPOCDetails_Result { get; set; } = null!;
        public virtual DbSet<sproc_Get_HiringRequest_SLADetails_Result> sproc_Get_HiringRequest_SLADetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_SLAUpdate_History_Result> Sproc_Get_SLAUpdate_History_Result { get; set; } = null!;

        public virtual DbSet<sproc_UTS_GetCompanyDetailsForEdit_Result> sproc_UTS_GetCompanyDetailsForEdit_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_FetchUsersWithSpecialEditAccess_Result> Sproc_UTS_FetchUsersWithSpecialEditAccess_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_SLAUpdateDetails_ForEmail_Result> Sproc_Get_SLAUpdateDetails_ForEmail_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Latest_ATS_HRStatus_Details_For_Notification_Result> Sproc_Get_Latest_ATS_HRStatus_Details_For_Notification_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_JobPost_Details_For_HomePage_ClientPortal_Result> Sproc_Get_JobPost_Details_For_HomePage_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<Sp_UTS_PreviewJobPost_ClientPortal_Result> Sp_UTS_PreviewJobPost_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<sproc_GetHRLost_Report_Result> sproc_GetHRLost_Report_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetTalentDetailHRLostPopUp_Result> sproc_UTS_GetTalentDetailHRLostPopUp_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_Update_Role_Result> Sproc_UTS_Update_Role_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetContactTimeZone_Result> Sproc_GetContactTimeZone_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_Get_OnBoardContract_Details_Result> Sproc_UTS_Get_OnBoardContract_Details_Result { get; set; } = null;
        public virtual DbSet<sproc_Get_ChatGPT_Response_For_UrlParsing_List_Result> sproc_Get_ChatGPT_Response_For_UrlParsing_List_Result { get; set; } = null;
        public virtual DbSet<Sproc_GetEmailDetailForTSCAssignment_Result> Sproc_GetEmailDetailForTSCAssignment_Result { get; set; } = null;
        public virtual DbSet<Sproc_UTS_GetAddClientAccess_Result> Sproc_UTS_GetAddClientAccess_Result { get; set; } = null;
        public virtual DbSet<Sproc_Get_OnBoardTalents_Result> Sproc_Get_OnBoardTalents_Result { get; set; } = null!;

        public virtual DbSet<sp_UTS_GetStandOutDetails_Result> sp_UTS_GetStandOutDetails_Result { get; set; } = null!;
        ...
        public virtual DbSet<Sproc_Get_JobPostCount_For_UTM_Tracking_Lead_Result> Sproc_Get_JobPostCount_For_UTM_Tracking_Lead_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_engagement_Edit_All_BR_PR_Result> Sproc_Get_engagement_Edit_All_BR_PR_Result { get; set; } = null!;
        public virtual DbSet<Sproc_FetchSimilarRoles_UTS_Result> Sproc_FetchSimilarRoles_UTS_Result { get; set; } = null!;
        public virtual DbSet<Sproc_talent_engagement_Details_For_PHP_API_Result> Sproc_talent_engagement_Details_For_PHP_API_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GET_UTM_Tracking_Report_Details_PopUP_Result> Sproc_GET_UTM_Tracking_Report_Details_PopUP_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Add_Contract_Renewal_Details_Result> Sproc_Add_Contract_Renewal_Details_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_ClientList_Result> sproc_UTS_ClientList_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_UTS_ClientPortalTracking_Details_Result> Sproc_Get_UTS_ClientPortalTracking_Details_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_UTS_ClientPortalTracking_Details_Popup_Result> Sproc_Get_UTS_ClientPortalTracking_Details_Popup { get; set; } = null!;
        public virtual DbSet<Sproc_GET_CreditPlanDetails_ClientPortal_Result> Sproc_GET_CreditPlanDetails_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<Sproc_RegisterClient_ClientPortal_Result> Sproc_RegisterClient_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<Sproc_ValidateAddClient_Result> Sproc_ValidateAddClient_Result { get; set; } = null!;
        public virtual DbSet<Sp_UTS_GetCreditUtilization_BasedOnHR_Result> Sp_UTS_GetCreditUtilization_BasedOnHR_Result { get; set; } = null!;
        public virtual DbSet<Sproc_GetActiveSalesUserList_Result> Sproc_GetActiveSalesUserList_Result { get; set; } = null!;
        public virtual DbSet<Sproc_InsertTicket_Result> Sproc_InsertTicket_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Update_HrStatus_Result> Sproc_Update_HrStatus_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_Get_HRStatus_Result> Sproc_UTS_Get_HRStatus_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_CreditWithAmount_Result> Sproc_Get_CreditWithAmount_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_GetCloseHRHistory_Result> Sproc_UTS_GetCloseHRHistory_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_Get_PayOut_Basic_Information_Result> Sproc_UTS_Get_PayOut_Basic_Informtion_Result { get; set; } = null!;
        public virtual DbSet<Sproc_CreateJDFromPrompt_ClientPortal_Result> Sproc_CreateJDFromPrompt_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<Sproc_CreateJDFromPrompt_UTSAdmin_Result> Sproc_CreateJDFromPrompt_UTSAdmin_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Fetch_All_SalesUsers_WithHead_For_Client_Result> Sproc_Fetch_All_SalesUsers_WithHead_For_Client_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_SalesUserWithHead_FOr_HiringRequest_Result> Sproc_Get_SalesUserWithHead_FOr_HiringRequest_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Credit_Transaction_CompanyWise_Result> Sproc_Get_Credit_Transaction_CompanyWise_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_CheckCreditAvailablilty_Result> Sproc_UTS_CheckCreditAvailablilty_Result { get; set; } = null!;
        public virtual DbSet<Sproc_RepostedJob_ClientPortal_Result> Sproc_RepostedJob_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_UpdateHR_Details_Result> Sproc_Get_UpdateHR_Details_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Identify_HRAssociated_WithDemoAccount_Result> Sproc_Identify_HRAssociated_WithDemoAccount_Result { get; set; } = null!;
        public virtual DbSet<sproc_Get_Replacement_Report_Result> sproc_Get_Replacement_Report_Result { get; set; } = null!;
        public virtual DbSet<sproc_Get_InterviewRoundDetails_Result> sproc_Get_InterviewRoundDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_HRIDEngagementID_ForReplacement_Result> Sproc_Get_HRIDEngagementID_ForReplacement_Result { get; set; } = null!;
        public virtual DbSet<Sproc_TalentEngagementConverted_C2H_Result> Sproc_TalentEngagementConverted_C2H_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_TalentBackout_Report_Result> Sproc_Get_TalentBackout_Report_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_OnBoardDetailFor_C2H_Result> Sproc_Get_OnBoardDetailFor_C2H_Result { get; set; } = null!;
        public virtual DbSet<sp_UTS_TalentCalculation_PayPerHire_Result> sp_UTS_TalentCalculation_PayPerHire_Result { get; set; } = null!;
        public virtual DbSet<Sproc_HR_POC_ClientPortal_Result> Sproc_HR_POC_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_Get_Onboarding_LegalInfo_Result> sproc_UTS_Get_Onboarding_LegalInfo_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetAutoCompleteCompany_Result> sproc_UTS_GetAutoCompleteCompany_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_HRClose_CheckTalentOfferHiredwithMessage_Result> sproc_UTS_HRClose_CheckTalentOfferHiredwithMessage_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Frequency_Office_Visit_Result> Sproc_Get_Frequency_Office_Visit_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_SalesHead_Users_Result> Sproc_Get_SalesHead_Users_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_AWS_SES_Tracking_Details_Popup_Result> Sproc_Get_AWS_SES_Tracking_Details_Popup_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_AWS_SES_Tracking_Details_Result> Sproc_Get_AWS_SES_Tracking_Details_Result { get; set; } = null!;
        public virtual DbSet<Sproc_EmailHRTypeChanged_Result> Sproc_EmailHRTypeChanged_Result { get; set; } = null!;
        public virtual DbSet<Sproc_HiringTypeDetails_ClientPortal_Result> Sproc_HiringTypeDetails_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_RejectionReasonForTalent_Result> Sproc_Get_RejectionReasonForTalent_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Fetch_TalentNotesEmailsLog_HRWise_Result> Sproc_Fetch_TalentNotesEmailsLog_HRWise_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Fetch_TalentNotesEmailsLog_Result> Sproc_Fetch_TalentNotesEmailsLog_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Fetch_TalentNotesEmailsLog_HRWise_TalentWise_Result> Sproc_Fetch_TalentNotesEmailsLog_HRWise_TalentWise_Result { get; set; } = null!;
        public virtual DbSet<Sproc_AddUpdate_TalentNotes_ClientPortal_Result> Sproc_AddUpdate_TalentNotes_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_GetUserByType_Result> Sproc_UTS_GetUserByType_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_GetSalesPerson_Result> Sproc_UTS_GetSalesPerson_Result { get; set; } = null!;
        public virtual DbSet<Sproc_SelfSignUpUserWithoutJobPost_ClientPortal_Result> Sproc_SelfSignUpUserWithoutJobPost_ClientPortal_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_SchedularUpdates_Result> Sproc_Get_SchedularUpdates_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_ShortListedDetails_ForCreditFlow_ClientPortal_Result> Sproc_Get_ShortListedDetails_ForCreditFlow_ClientPortal { get; set; } = null!;
        #endregion
        ...
        public virtual DbSet<Sproc_Get_Basic_CompanyDetails_Result> Sproc_Get_Basic_CompanyDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Company_Funding_Details_Result> Sproc_Get_Company_Funding_Details_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Company_CultureandPerksDetails_Result> Sproc_Get_Company_CultureandPerksDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Company_PerksDetails_Result> Sproc_Get_Company_PerksDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_Get_Company_YouTubeDetails_Result> Sproc_Get_Company_YouTubeDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_CompanyDetail_TransferToATS_Result> Sproc_CompanyDetail_TransferToATS_Result { get; set; } = null!;
        public virtual DbSet<sp_UTS_GetPOCUserIDByCompanyID_Result> sp_UTS_GetPOCUserIDByCompanyID_Result { get; set; } = null!;
        public virtual DbSet<sproc_UTS_GetCompanyEngagementDetails_Result> sproc_UTS_GetCompanyEngagementDetails_Result { get; set; } = null!;
        public virtual DbSet<sp_UTS_GetPOCUserIDByCompanyID_Edit_Result> sp_UTS_GetPOCUserIDByCompanyID_Edit_Result { get; set; } = null!;
        public virtual DbSet<SP_PayPerHire_CalculationDetails_Result> SP_PayPerHire_CalculationDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_GetCompanyWhatsappDetails_Result> Sproc_UTS_GetCompanyWhatsappDetails_Result { get; set; } = null!;
        public virtual DbSet<Sproc_UTS_SaveCompanyWhatsappDetails_Result> Sproc_UTS_SaveCompanyWhatsappDetails_Result { get; set; } = null!;
        #endregion
